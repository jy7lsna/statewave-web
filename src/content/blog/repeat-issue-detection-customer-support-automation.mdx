...
image: /images/blog/repeat-issue-detection-customer-support-automation/og.png
headerImage: /images/blog/repeat-issue-detection-customer-support-automation/header.png
tags:
  - support
  - ranking
  - retrieval
...
<img src="/images/blog/repeat-issue-detection-customer-support-automation/image1.png" alt="Repeat-issue detection running inside context assembly: keywords extracted from the live issue, compared against each resolved session, boosting those that clear the threshold before the bundle is packed." width="2000" height="940" loading="lazy" className="w-full rounded-2xl border border-brand-500/20 bg-white" />
...
<figure className="my-8">
<img src="/images/blog/repeat-issue-detection-customer-support-automation/image2.png" alt="Score adjustments on episodes from a resolved session when the issue recurs: minus five penalty, plus four without a summary, plus six with one." width="2000" height="1040" loading="lazy" className="w-full rounded-2xl border border-brand-500/20 bg-white" />
...
<figure className="my-8">
<img src="/images/blog/repeat-issue-detection-customer-support-automation/image3.png" alt="Keyword overlap scores for seven phrasings of one recurring issue, six clearing the 0.30 threshold and one scoring zero." width="2000" height="1000" loading="lazy" className="w-full rounded-2xl border border-brand-500/20 bg-white" />
...
<figure className="my-8">
<img src="/images/blog/repeat-issue-detection-customer-support-automation/image4.png" alt="One resolution record feeding four surfaces: retrieval ranking, health scoring, SLA calculation, and the handoff pack." width="2000" height="1080" loading="lazy" className="w-full rounded-2xl border border-brand-500/20 bg-white" />
...
<div className="px-7 pb-7">
<div className="h-px bg-theme-primary/10 mb-6" />
<p className="text-[16px] leading-8 text-theme-secondary/80 !m-0">Not today. The weights are constants in <code>server/services/context.py</code> with no per-tenant override, a deliberate choice to keep ranking deterministic and reproducible. You can scope requests by subject, filter /v1/memories/search results by kind, or modify the context assembler in your own self-hosted deployment.</p>
</div>
</details>
