...
<div><p className="font-heading text-3xl sm:text-4xl font-bold text-theme-primary !m-0">0.905</p><p className="mt-1 text-xs text-theme-secondary/80 !m-0">LoCoMo, mem0's harness</p></div>
</div>
</div>
