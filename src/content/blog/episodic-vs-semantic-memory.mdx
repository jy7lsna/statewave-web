...
<div><p className="font-heading text-3xl sm:text-4xl font-bold text-theme-primary !m-0">8</p><p className="mt-1 text-xs text-theme-secondary/80 !m-0">support eval criteria</p></div>
</div>
</div>
