...
<img src="/images/blog/ai-support-agent-session-state/image1.png" alt="Two scopes side by side: a subject holding durable customer facts, and sessions holding individual tickets with their own state." width="624" height="283" loading="lazy" className="w-full rounded-2xl border border-brand-500/20 bg-white" />
...
<figure className="my-8">
<img src="/images/blog/ai-support-agent-session-state/image2.png" alt="Bar chart of maximum points per signal family on one raw conversation turn: session state 14, recency 5, lexical overlap 5, base priority 3, embedding similarity 0." width="624" height="283" loading="lazy" className="w-full rounded-2xl border border-brand-500/20 bg-white" />
...
<figure className="my-8">
<img src="/images/blog/ai-support-agent-session-state/image3.png" alt="The same closed-session episode scored twice: without a resolution summary it nets minus one, with a summary it nets plus one." width="624" height="275" loading="lazy" className="w-full rounded-2xl border border-brand-500/20 bg-white" />
